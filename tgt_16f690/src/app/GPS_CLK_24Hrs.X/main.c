 ...
 * Author: Raja-L
 *
 * Created on 3 April, 2025, 5:16 PM
 */
...
void main() 
{
    ...
    if(sec > 5){
        PORTC=0x00; PORTA=0x00; PORTBbits.RB4=0; PORTBbits.RB6=0; 
        //send_char('N');
        sec=0;
    }
        ...
        PORTC=IST_TIME1[0]; PORTA=0xFE;      __delay_ms(5); PORTA=0xFF; PORTBbits.RB4=1;PORTBbits.RB6=1;
        PORTC=IST_TIME1[1]; PORTA=0xFD;      __delay_ms(5); PORTA=0xFF; PORTBbits.RB4=1;PORTBbits.RB6=1;
        PORTC=IST_TIME1[2]; PORTA=0xFB;      __delay_ms(5); PORTA=0xFF; PORTBbits.RB4=1;PORTBbits.RB6=1; 
        PORTC=IST_TIME1[3]; PORTA=0x1F;      __delay_ms(5); PORTA=0xFF; PORTBbits.RB4=1;PORTBbits.RB6=1;
        
        /*PORTC=IST_TIME1[4]; PORTBbits.RB4=0; __delay_ms(10); PORTA=0xFF; PORTBbits.RB4=1;PORTBbits.RB6=1;
        PORTC=IST_TIME1[5]; PORTBbits.RB6=0; __delay_ms(10); PORTA=0xFF; PORTBbits.RB4=1;PORTBbits.RB6=1;*/
        Temp_Cnt=0; error_cnt=0;sec=0;//send_char('K');
...
//            {
//                //send_char('N');
//               //PORTC=error_cnt; PORTA=0x00; PORTBbits.RB4=0;PORTBbits.RB6=0;
//            }
//        }
